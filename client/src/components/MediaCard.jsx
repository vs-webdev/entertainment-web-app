...
const MediaCard = ({index, year, category, rating, title, isBookmarked, toggleBookmark}) => {
  ...
  return (
    <div key={index} className="flex flex-col items-start justify-center">
      ...
      >
        <p>Thumbnail</p>
        <div 
          className='absolute top-3 right-3 flex items-center justify-center h-8 w-8 rounded-full bg-gray-500'
